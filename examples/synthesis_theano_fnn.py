...
def run_fnn():
    ...
    p = OrderedDict([
        ...
        ("train_data_path", "../data/synthesis/train/"), 
        ("test_data_path", "../data/synthesis/test/"), 
        ("left_win", 5), 
        ("right_win", 5), 
        ("use_verb", False), 
        ("train_part", 1.0), 
        ("validation_part", 0.0),   # Validation part and train_part are from train_data_path
        ("test_part", 1.0), 
        ("minimum_sent_num", 0), # Minimum number of sentences of training data
        ("minimum_frame", 0),  # Minimum frame of verb of training data
        ...
        ("\nOther parameters", ""), 
        ("prediction_results", "../result/synthesis/prediction_results") 
    ])
    ...
    train_loader = DataLoader(
        ...
        left_win=p["left_win"], right_win=p["right_win"], use_verb=p["use_verb"]
    )
